...
export const handler = async (event) => {
  ...
  try {
    // Declare query variable in the correct scope
    let query = "";

    // Parameters come as an array: [{"name": "query", "type": "string", "value": "Amazon Nova Pro"}]
    ...
    // Fallback to inputText if query not found in parameters
